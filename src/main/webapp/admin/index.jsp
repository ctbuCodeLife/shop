    ...
    <div class="row-fluid">
        <div class="col-md-2 navbar">
            ...
            <ul>
                ...
                <li><a href="listSales.jsp" target="mainFrame">订单管理</a>
                    <ul id="salesMenu" class="submenu">
                        <li><a href="querySales.jsp" target="mainFrame">查询管理员</a></li>
                        <li><a href="addSales.jsp" target="mainFrame">添加管理员</a></li>
                    </ul>
                </li>
                <li><a href="listCustomer.jsp" target="mainFrame">用户管理</a>
                    <ul id="customerMenu" class="submenu">
                        <li><a href="queryCustomer.jsp" target="mainFrame">查询管理员</a></li>
                        <li><a href="addCustomer.jsp" target="mainFrame">添加管理员</a></li>
                    </ul>
                </li>
